...
pub const KEY_ENC_FILE: &str = "enc_file";
pub const HELP_ENC_FILE: &str = "Create an encrypted file";
...
pub const KEY_DEC_FILE: &str = "dec_file";
pub const HELP_DEC_FILE: &str = "decrypt file";
pub const VALUE_DEC_FILE: &str = "DEC_FILE";
pub const LONG_ARG_DEC_FILE: &str = "dec-file";
...
pub const KEY_INSERT_KEY_FILE: &str = "insert_key_file";
pub const HELP_INSERT_KEY_FILE: &str = "file to insert key into";
pub const VALUE_INSERT_KEY_FILE: &str = "INSERT_KEY_FILE";
pub const LONG_ARG_INSERT_KEY_FILE: &str = "insert-file";

pub const KEY_INSERT_KEY_KEY: &str = "insert_key_key";
pub const HELP_INSERT_KEY_KEY: &str = "key to insert";
pub const VALUE_INSERT_KEY_KEY: &str = "INSERT_KEY_KEY";
pub const LONG_ARG_INSERT_KEY_KEY: &str = "insert-key";
